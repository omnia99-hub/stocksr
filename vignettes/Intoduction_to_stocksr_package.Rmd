...
- **Performance comparison**  
  Computes error metrics (RMSE, MAE, R²) to benchmark models across different sectors.
...
- 🏷️ **Maps** each company to its corresponding sector  
